...
from random_messages import already_picked, only_numbers_are_allowed, sorry_you_lost, you_guessed_right, you_guessed_wrong, you_won
...
while command != "0":
    if command == "1":
        ...
        right_guesses = 0
        wrong = 0
        message = f"Guess a number between 1 and 10"
